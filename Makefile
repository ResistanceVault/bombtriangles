...
zip:
	cd .. && zip -r flash2022.zip ./flash2022 -x "*/.*" -x "flash2022/AProcessing2/tests*" -x "flash2022/build*" -x "flash2022/rcompresso" -x "flash2022/r" -x "flash2022/wolfram" && cd flash2022