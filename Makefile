...
zip:
	cd .. && rm -f flash2022.zip && zip -r flash2022.zip ./flash2022 -x "flash2022/sketchbook*" -x "*/.*" -x "flash2022/rliscio" -x "flash2022/reffect" -x "flash2022/r" -x "flash2022/AProcessing2/tests*" -x "flash2022/AProcessing2/fusuae-unit-tester*" -x "flash2022/wolfram*" -x "flash2022/build*" -x "flash2022/rcompresso" -x "flash2022/r" -x "flash2022/*.adf" -x "flash2022/wolfram" && cd flash2022